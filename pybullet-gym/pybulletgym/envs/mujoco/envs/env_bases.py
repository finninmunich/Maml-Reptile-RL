...
class BaseBulletEnv(gym.Env):
    ...
    def _reset(self,joints_coef = None,dynamics_coef = None):
        ...
        self.reward = 0
        dump = 0
        s = self.robot.reset(self._p,joints_coef = joints_coef,dynamics_coef = dynamics_coef)
    ...
    def move_and_look_at(self, i=10, j=10, k=-20,x=0, y=0, z=0, ):
        lookat = [x, y, z]
        distance = i
        yaw = j
        pitch = k
