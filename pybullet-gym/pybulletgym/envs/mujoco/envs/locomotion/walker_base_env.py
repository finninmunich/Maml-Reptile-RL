...
class WalkerBaseMuJoCoEnv(BaseBulletEnv):
    def __init__(self, robot, render=False,joints_coef = None,dynamics_coef = None):
    ...
    def reset(self):
        ...
        r = BaseBulletEnv._reset(self,joints_coef=self.joints_coef,dynamics_coef=self.dynamics_coef)
    ...
    def camera_adjust(self):
        x= self.robot_body.get_pose()
        y = x[1]
        x = x[0]
        #print(x,y)
        #self.camera_x = 0.98*self.camera_x + (1-0.98)*x
        #self.move_and_look_at(self.camera_x, y-2.0, 1.4, x, y, 1.0)
        self.move_and_look_at(2, 10, -20, x, y, 1.0)
